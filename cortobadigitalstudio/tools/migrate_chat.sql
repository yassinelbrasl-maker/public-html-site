...
CREATE TABLE IF NOT EXISTS `CDS_chat_rooms` (
...
-- Messages
CREATE TABLE IF NOT EXISTS `CDS_chat_messages` (
  `id`              VARCHAR(32)  NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS `CDS_chat_participants` (
  `room_id`      VARCHAR(32)  NOT NULL,
...
CREATE TABLE IF NOT EXISTS `CDS_chat_pinned` (
  `id`         VARCHAR(32)  NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS `CDS_chat_presence` (
