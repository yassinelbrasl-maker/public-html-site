...
self.addEventListener('push', function(event) {
    ...
    var options = {
        body:    payload.body || '',
        icon:    payload.icon || '/cortobadigitalstudio/img/cortoba-icon-192.png',
        badge:   payload.badge || '/cortobadigitalstudio/img/cortoba-badge-72.png',
...
self.addEventListener('notificationclick', function(event) {
    ...
    var url = '/cortobadigitalstudio/plateforme-nas.html';
    var data = event.notification.data || {};

    if (data.url) {
        url = data.url;
    } else if (data.linkPage) {
        url = '/cortobadigitalstudio/plateforme-nas.html#page=' + data.linkPage;
    }
