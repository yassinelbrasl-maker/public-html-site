...
function renderNotificationsPage(){document.querySelectorAll('#page-notifications .nf-tab').forEach(function(t){var a=t.getAttribute('data-nf-status')===_nfState.status;t.classList.toggle('active',a);t.style.color=a?'var(--text-2)':'var(--text-3)';t.style.borderBottom=a?'2px solid var(--accent)':'2px solid transparent';});notifLoadList();}
